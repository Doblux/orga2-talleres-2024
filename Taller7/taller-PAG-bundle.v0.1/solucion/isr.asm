...
%define TRUE  0x100001
%define FALSE 0x100000
...
_isr14:
    ...
    mov eax, cr2 ; cuando se produce un page fault, el procesador guarda la dirección lineal que causó el fallo en el registro CR2
    push eax ; argumento de funcion por stack
