...
_isr32:
    ...
    call pic_finish1
    popad
    iret ; iret se usa para retornar desde una tarea anidada o interrupcion
...
_isr33:
    pushad
    xor eax, eax
    in al, 0x60 ; leo del puerto 0x60
    push eax ; (en 32bits argumentos de funcion se pasan por stack)
